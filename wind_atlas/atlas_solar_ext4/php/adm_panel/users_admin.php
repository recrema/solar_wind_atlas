		...
		if ($_POST["action"]=="del")
		  {
			  ...
			  else
			  {
				...
				echo '<p>User successfully deleted.</p><button type="button" class="pure-button pure-button-green" onclick="botao2()">Ok</button>';
		  		...
		  		echo '<p>You do not have permitions!</p><button type="button" class="pure-button pure-button-green" onclick="location.reload();">Ok</button>';
		  	}
		  }
		  //////////////////////////////////////////FIQUEI AQUI NA SEGURANCA, TENHO DE CONTINUAR//////////////////////////////////////////////////////////////////////////////

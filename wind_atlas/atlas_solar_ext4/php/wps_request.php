...
if ($series1=== NULL) {
	...
	file_put_contents('../tmp/chart.json',$json1_2);
	...
	file_put_contents('../tmp/chart2.json',$json2_2);
	...
	file_put_contents('../tmp/chart3.json',$json3_2);
	...
	$output1 = '
			<br>
			<br>
			<a href="javascript:void(0)"><img id="windRose1" src="tmp/chart.png" width="160" height="100" onmouseover="bigImg1(this)" onmouseout="normalImg1(this)" onClick="mapController.onChartActivate('.$json.',\'windRose1\');"></a>
			<a href="javascript:void(0)"><img id="windRose2" src="tmp/chart2.png" width="160" height="100" onmouseover="bigImg1(this)" onmouseout="normalImg1(this)" onClick="mapController.onChartActivate('.$json2.',\'windRose2\');"></a>';
	
	$output2 = '
			<br>
			<br>
			<a href="javascript:void(0)"><img id="windChart2" src="tmp/chart3.png" width="160" height="100" onmouseover="bigImg2(this)" onmouseout="normalImg2(this)" onClick="mapController.onChartActivate('.$json3.',\'windChart2\');"></a>';
	...
	for ($loop = 1; $loop <= $pagecount; $loop++) {
		...
		* ****************************************/
		if ($loop == 1){
					...
					$pdf->Image('../tmp/chart.png', 0.1*72, 1.9*72, 230, 153);
					
					$pdf->Image('../tmp/chart2.png', 5.3*72, 1.9*72, 230, 153);
					$pdf->Image('../tmp/chart2.png', 2.68*72, 1.9*72, 230, 153);
					
					$pdf->Image('../tmp/chart2.png', 0.2*72, 4.7*72, 230, 153);
					$pdf->Image('../tmp/chart2.png', 2.7*72, 4.7*72, 230, 153);
	...
	$output3 = '
			...
			&nbsp;
			&nbsp;
			<a href="tmp/teste.pdf" target="_blank" title="Download PDF Report"><img id="windReport" src="resources/images/download_pdf.png" width="78" height="100" onmouseover="bigImg3(this)" onmouseout="normalImg3(this)"></a>';
